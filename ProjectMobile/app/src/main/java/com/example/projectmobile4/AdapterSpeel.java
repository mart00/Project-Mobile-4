...
//        this.mp3 = mp3;
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int postition) {
        ...
        int img0 = routes[rr(routes,postition)];
        int img1 = routes[rr(routes,postition)];
        int img2 = routes[rr(routes,postition)];
        int img3 = routes[rr(routes,postition)];
        int img4 = routes[rr(routes,postition)];
        int img5 = routes[rr(routes,postition)];

        switch (correct){
            case 0:
                img0 = routes[postition];
                break;
            case 1:
                img1 = routes[postition];
                break;
            case 2:
                img2 = routes[postition];
                break;
            case 3:
                img3 = routes[postition];
                break;
            case 4:
                img4 = routes[postition];
                break;
            default:
                img5 = routes[postition];
        }
